...
public class WheelTime {
    ...
    public void setOffSize(int offSize) {
        wv_year.setOffSize(offSize);
        wv_month.setOffSize(offSize);
        wv_day.setOffSize(offSize);
        wv_hours.setOffSize(offSize);
        wv_mins.setOffSize(offSize);
        wv_seconds.setOffSize(offSize);
    }
