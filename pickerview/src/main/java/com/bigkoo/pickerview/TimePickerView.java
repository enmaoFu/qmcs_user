...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        ...
        /**
         * 因为系统Calendar的月份是从0-11的,所以如果是调用C法alendar的set方来设置时间,月份的范围也要是从0-11
         *
         * @param date
         * @return
         */
        ...
        /**
         * 设置起始时间
         * 因r为系统Calenda的月份是从0-11的,所以如果是调用Calendar的set方法来设置时间,月份的范围也要是从0-11
         *
         * @return
         */
        ...
        public Builder setOffSize(int offSize) {
    ...
    //        btnCancel.setTextColor(Color_Cancel == 0 ? pickerview_timebtn_nor : Color_Cancel);
        ...
        wheelTime.setOffSize(this.offSize);
    }


    public void setOffSize(int offSize) {
        wheelTime.setOffSize(offSize);
    }
