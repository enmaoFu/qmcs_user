...
public class TransferSearchAty extends BaseAty implements GeocodeSearch.OnGeocodeSearchListener {
    @Bind(R.id.toolbar)
    Toolbar mToolbar;
    @Bind(R.id.tv_date)
    TextView mTvDate;
    ...
    public void initData() {
        initToolbar(mToolbar, "搜索抢单");
        mTvCommit.setText("搜索");
    ...
    public void btnClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_commit:
                ...
                String time = DateTool.strTimeToTimestamp(dateString + " " + timeString, "yyyy.MM.dd HH:mm") + "";


                ConditionItem conditionItem = new ConditionItem();

                conditionItem.setDate(dateString);
                conditionItem.setHour(timeString);
                conditionItem.setTime(time);
                conditionItem.setStartAddress(startCityName + startDistrictName);
                conditionItem.setEndAddress(endCityName + endDistrictName);
                conditionItem.setStartCityCode(startDistrictCode);
                conditionItem.setEndCityCode(endDistrictCode);
                conditionItem.setStartStreetCode(startStreetCode);
                conditionItem.setEndStreetCode(endStreetCode);
                Bundle bundle1 = new Bundle();

                bundle1.putParcelable("data", conditionItem);
                startActivity(TransferRobSearchActivity.class, bundle1);
        ...
        AndPermission.with(this)
                ...
                .rationale(new RationaleListener() {
                               ...
                               public void showRequestPermissionRationale(int requestCode, Rationale rationale) {
                                   ...
                                   AndPermission.rationaleDialog(TransferSearchAty.this, rationale).show();
                               }
                           }
                )
                .send();
    ...
    private PermissionListener listener = new PermissionListener() {
        ...
        public void onSucceed(int requestCode, List<String> grantedPermissions) {
            ...
            if (requestCode == 200) {
                ...
                MyLocationUtil locationUtil = new MyLocationUtil(TransferSearchAty.this, new MyLocationUtil.MyLocationListener() {
                    @Override
                    public void sussessLocation(double lat, double lon, final AMapLocation location) {
                        ...
                        if (location != null) {
                            ...
                            locationAddress = location.getDescription();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == 1 && data != null) {
            ...
            startDetailName = chooseAddress.getAddress();
    ...
    public void onRegeocodeSearched(RegeocodeResult regeocodeResult, int i) {
        if (i == 1000) {
            ...
            setLocationCity(regeocodeResult.getRegeocodeAddress().getProvince(), regeocodeResult.getRegeocodeAddress().getCity(), regeocodeResult.getRegeocodeAddress().getDistrict(), regeocodeResult.getRegeocodeAddress().getTownship(), locationStreet + address);
        }
    }
