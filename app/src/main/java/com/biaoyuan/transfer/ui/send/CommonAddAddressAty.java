...
/**
 * Title  :从常用地址进来的添加或者编辑
 * Create : 2017/4/26
 * Author ：chen
 */

public class CommonAddAddressAty extends BaseAty implements GeocodeSearch.OnGeocodeSearchListener {
    @Bind(R.id.toolbar)
    Toolbar mToolbar;
    @Bind(R.id.et_name)
    EditText mEtName;
    ...
    private SendCommonAddressInfo mItem;
    ...
    public void initData() {
        ...
        switch (type) {
            case 2:
                ...
                if (mItem == null) {
                    initToolbar(mToolbar, "新增收件人信息");
                } else {
                    initToolbar(mToolbar, "编辑收件人信息");
                    mName = mItem.getAddressName();
                    mEtName.setText(mName);

                    mPhone = mItem.getAddressPhone() + "";
                    mEtPhone.setText(mPhone);

                    String address[] = mItem.getAddressAddress().split("\\|");
                    ...
                    cityParentCode = mItem.getAddressAreaCode();
                    streetParentCode = mItem.getAddressAreaId();

                    lat = mItem.getAddressLat();
                    lng = mItem.getAddressIng();
            ...
            case 1:
                if (mItem == null) {
                    initToolbar(mToolbar, "新增寄件人信息");
                } else {
                    initToolbar(mToolbar, "编辑寄件人信息");
                    mName = mItem.getAddressName();
                    mEtName.setText(mName);
    ...
    public void btnClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.commit_btn:
                ...
                mGetHome = mEtHome.getText().toString();
                ...
                if (mItem != null) {
                    ...
                    if (TextUtils.isEmpty(mGetHome)) {
                        doHttp(RetrofitUtils.createApi(Send.class).upUserAddress(mName, Long.parseLong(mPhone), provinceName + "|" + cityName + "|" + districtName + "|" + mGetStreeParen + "|" + mDetailsAddress, lng, lat, mItem.getAddressId(), cityParentCode, streetParentCode), 1);
                    } else {
                        doHttp(RetrofitUtils.createApi(Send.class).upUserAddress(mName, Long.parseLong(mPhone), provinceName + "|" + cityName + "|" + districtName + "|" + mGetStreeParen + "|" + mDetailsAddress + "|" + mGetHome, lng, lat, mItem.getAddressId(), cityParentCode, streetParentCode), 1);
                    }
        ...
        AndPermission.with(this)
                ...
                .rationale(new RationaleListener() {
                               ...
                               public void showRequestPermissionRationale(int requestCode, Rationale rationale) {
                                   ...
                                   AndPermission.rationaleDialog(CommonAddAddressAty.this, rationale).show();
                               }
                           }
                )
                .send();
    ...
    private PermissionListener listener = new PermissionListener() {
        ...
        public void onSucceed(int requestCode, List<String> grantedPermissions) {
            ...
            if (requestCode == 200) {
                ...
                MyLocationUtil locationUtil = new MyLocationUtil(CommonAddAddressAty.this, new MyLocationUtil.MyLocationListener() {
                    @Override
                    public void sussessLocation(double lat, double lon, final AMapLocation location) {

                        if (location != null) {

                            CommonAddAddressAty.this.lat = lat;
                            CommonAddAddressAty.this.lng = lon;
