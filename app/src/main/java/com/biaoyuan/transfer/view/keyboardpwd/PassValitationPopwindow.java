...
//		mMenuView = LayoutInflater.from(mContext).inflate(R.layout.pop_view, null);
		...
		ivLeft           = (TextView) mMenuView.findViewById(R.id.iv_pop_dismiss);
		tvTitle          = (TextView) mMenuView.findViewById(R.id.tv_pop_title);
		forget_pwd       = (TextView) mMenuView.findViewById(R.id.forget_pwd);
	...
	public void onClick(View view) {
		...
		case R.id.iv_pop_dismiss:
			...
			/*case R.id.forget_pwd:
				...
				intent.setClass(mContext,MineUpdatePwdFristAty.class);
	...
	public interface OnInputNumberCodeCallback {
		void onSuccess(String numberString);
	}
